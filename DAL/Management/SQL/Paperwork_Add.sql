...
insert into Paperwork(Id, Vehicle_Id, Client_Id, Invoice_Id, Paperwork_Precharge_Code, Transfer_Date, Observations, IsFinished,DVH)
values (@Id, @Vehicle_Id, @Client_Id, @Invoice_Id, @Paperwork_Precharge_Code, @Transfer_Date, @Observations, @IsFinished,@DVH)

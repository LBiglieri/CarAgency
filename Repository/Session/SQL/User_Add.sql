...
insert into Users(Id,Dni,Username,Password,Name,Surname,Role,Blocked,Active,Available_Login_Attempts) 
values (@Id,@Dni,@Username,@Password,@Name,@Surname,@Role,@Blocked,@Active,@Available_Login_Attempts)
